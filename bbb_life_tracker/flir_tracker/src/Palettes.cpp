...
uint8_t colormap_whitehotRGB[LUT_SIZE_8*3];
...
void getHeatMapColorBYR(double value, double& red, double& green, double& blue)
{
    ...
    static double color[NUM_COLORS][3] = { {0,0,1}, {0,1,1}, {1,0,0} };
...
void getHeatMapColorBGYR(double value, double& red, double& green, double& blue)
{
    ...
    static double color[NUM_COLORS][3] = { {0,0,1}, {0,1,0}, {0,1,1}, {1,0,0} };
...
void getHeatMapColorWhiteHotRGB(double value, double& red, double& green, double& blue)
{
    const int NUM_COLORS = 5;
    static double color[NUM_COLORS][3] = { {0,0,0, }, {0,0,1}, {0,1,1}, {1,0,0}, {1,1,1} };
    // A static array of 3 colors:  (black, blue, yellow, red, white) using {r,g,b} for each.
...
void createColorMaps()
{
    ...
    for( int i=0; i<LUT_SIZE_8; i++  )
    {
        ...
        // >>>>> WhiteHot RGB
        getHeatMapColorWhiteHotRGB( val, r,g,b );

        r8=static_cast<uint8_t>(r*255+0.5);
        g8=static_cast<uint8_t>(g*255+0.5);
        b8=static_cast<uint8_t>(b*255+0.5);

        colormap_whitehotRGB[i*3+0] = r8;
        colormap_whitehotRGB[i*3+1] = g8;
        colormap_whitehotRGB[i*3+2] = b8;
        // <<<<< WhiteHot RGB
    }
}
